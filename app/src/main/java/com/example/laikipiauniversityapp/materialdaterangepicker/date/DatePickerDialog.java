...
package com.example.laikipiauniversityapp.materialdaterangepicker.date;
...
import com.example.laikipiauniversityapp.materialdaterangepicker.HapticFeedbackController;
import com.example.laikipiauniversityapp.materialdaterangepicker.TypefaceHelper;
import com.example.laikipiauniversityapp.materialdaterangepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements
        OnClickListener, com.example.laikipiauniversityapp.materialdaterangepicker.date.DatePickerController {
    ...
    private com.example.laikipiauniversityapp.materialdaterangepicker.date.AccessibleDateAnimator mAnimator;
    ...
    private com.example.laikipiauniversityapp.materialdaterangepicker.date.DayPickerView mDayPickerView;
    private com.example.laikipiauniversityapp.materialdaterangepicker.date.YearPickerView mYearPickerView;
    ...
    private com.example.laikipiauniversityapp.materialdaterangepicker.date.SimpleDayPickerView mDayPickerViewEnd;
    private com.example.laikipiauniversityapp.materialdaterangepicker.date.YearPickerView mYearPickerViewEnd;
    private com.example.laikipiauniversityapp.materialdaterangepicker.date.AccessibleDateAnimator mAnimatorEnd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDayPickerView = new com.example.laikipiauniversityapp.materialdaterangepicker.date.SimpleDayPickerView(activity, this);
        mYearPickerView = new com.example.laikipiauniversityapp.materialdaterangepicker.date.YearPickerView(activity, this);
        mDayPickerViewEnd = new com.example.laikipiauniversityapp.materialdaterangepicker.date.SimpleDayPickerView(activity, this);
        mYearPickerViewEnd = new com.example.laikipiauniversityapp.materialdaterangepicker.date.YearPickerView(activity, this);
        ...
        mAnimator = (com.example.laikipiauniversityapp.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.range_animator);
        mAnimatorEnd = (com.example.laikipiauniversityapp.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.range_animator_end);
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                com.example.laikipiauniversityapp.materialdaterangepicker.date.MonthAdapter.CalendarDay calendarDay;
                if(tabId.equals("start")){
                    calendarDay = new com.example.laikipiauniversityapp.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar.getTimeInMillis());
                    mDayPickerView.goTo(calendarDay,true,true,false);
                }
                else{
                    calendarDay = new com.example.laikipiauniversityapp.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd.getTimeInMillis());
    ...
    @Override
    public com.example.laikipiauniversityapp.materialdaterangepicker.date.MonthAdapter.CalendarDay getSelectedDay() {
        if(tabHost.getCurrentTab()==0){
            return new com.example.laikipiauniversityapp.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar);
        }else{
            return new com.example.laikipiauniversityapp.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd);
        }
